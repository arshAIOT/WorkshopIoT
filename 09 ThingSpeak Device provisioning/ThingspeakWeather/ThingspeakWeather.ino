...
char mqttPass[] = "4QBA1EDBD32YSXBK"; // Change to your MQTT API Key from Account > MyProfile.   
char writeAPIKey[] = "80L044TEYCJLTLZE"; // Change to your channel write API key.
long channelID = 1549625; // Change to your channel ID.
...
void mqttPublishField(int fieldNum) {
  ...
  sensorVal = analogRead(sensorPin); // Read temperature from DHT sensor.
  
  // Create data string to send to ThingSpeak.
  String data = String(sensorVal, DEC);
